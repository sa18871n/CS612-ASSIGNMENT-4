...
const url='https://newsapi.org/v2/top-headlines?country=us&apiKey=e3f19cde6cf3429f8379c2451be16a48';
...
if(!articles) return null;
  ...
  return (
    <div class="nav">
      <Link to="/" >
				<h3 class="nav-heading1">HOME PAGE</h3>
			</Link>
      <br/>
      <h1 className="nav-heading2">TODAY'S TOP NEWS</h1>
      <hr/>
      <div className="weatherApi">
       {/* Fetching only 5 data at a time  */}
      {articles.filter((ele,index) => index < 4).map((item) => (
        <>
